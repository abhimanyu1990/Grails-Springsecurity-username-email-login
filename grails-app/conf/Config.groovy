...
grails {
	mail {
	  host = "smtp.gmail.com"
	  port = 465
	  username = "abhimanyu.mailme@gmail.com"
	  password = "*************"
...
//Spring security registration email subject
grails.plugin.springsecurity.ui.register.emailSubject = 'Welcome to Organization'
